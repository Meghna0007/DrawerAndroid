...
import static com.example.OPM_B2B.MyAccountFragment.MANAGE_ADDRESS;
import static com.example.OPM_B2B.MyAddressesActivity.refreshItem;
...
public class AddressesAdapter extends RecyclerView.Adapter<AddressesAdapter.Viewholder> {
    ...
    public Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AddressesAdapter.Viewholder(view);
    }
